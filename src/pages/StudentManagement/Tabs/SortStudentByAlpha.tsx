...
import { ROLL_TABLE_COLS_SORT_ALPHA } from "./RollTableColumn";
...
const SortStudentByAlpha: React.FC<SortStudentByAlphaProps> = ({ students, fetchStudents }) => {
    ...
    <>
      ...
      <Paper>
        <MaterialTable
          ...
          columns={ROLL_TABLE_COLS_SORT_ALPHA}
          data={students}
          options={{
            search: false,
            showTitle: false,
...
export default SortStudentByAlpha