                ...
                <Suspense>
                  <Routes>
                    <Route path="/" element={<DashboardLayoutNew />}>
                      ...
                      <Route path="students/add" element={<AddStudentNew />} />
                      ...
                      />
                      <Route
                        path="reports/admit-card"
                        element={<GenerateAdmitCard />}
                      />
                      <Route
                        path="reports/students-list"
                        element={<StudentsList />}
                      />
                      <Route
                        path="reports/faculty-list"
                        element={<FacultyList />}
                      />
                      <Route
                        path="reports/faculty-daily-attendance"
                        element={<FacultyDailyAttendanceReport />}
                      />
                      <Route
                        path="reports/faculty-monthly-attendance"
                        element={<FacultyMonthlyAttendanceReport />}
                      />
                      ...
                      <Route
                        ...
                        element={<StudentRollNumberAllocation />}
                      />
                      <Route
